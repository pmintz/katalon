...
//change
WebUI.setText(findTestObject('RegisterClient/enterDataUntilClearance/input_lastName'), 'Go')
...
WebUI.selectOptionByValue(findTestObject('RegisterClient/enterDataUntilClearance/select_Female Male'), 'M',
	false)
//change
WebUI.setText(findTestObject('RegisterClient/enterDataUntilClearance/input_ssn1ssn'), '999')
//change
WebUI.setText(findTestObject('RegisterClient/enterDataUntilClearance/input_ssn2ssn'), '99')
//change
...
//change
WebUI.setText(findTestObject('Object Repository/RegisterClient/remaningDataEntry/Page_VaCMS/input_lastName'), 'Go')
...
//change
WebUI.setText(findTestObject('Object Repository/RegisterClient/remaningDataEntry/Page_VaCMS/input_ssn1ssn'), '999')
//change
WebUI.setText(findTestObject('Object Repository/RegisterClient/remaningDataEntry/Page_VaCMS/input_ssn2ssn'), '99')
//change
